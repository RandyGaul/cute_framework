 ...
 * @related  CF_Rnd cf_rnd_seed cf_rnd_float cf_rnd_double cf_rnd_range_int cf_rnd_range_uint64 cf_rnd_range_float cf_rnd_range_double
 */
...
CF_INLINE uint64_t cf_rnd_uint64(CF_Rnd* rnd)
{
...
CF_INLINE float cf_rnd_float(CF_Rnd* rnd)
{
	uint32_t value = (uint32_t)(cf_rnd_uint64(rnd) >> 32);
...
CF_INLINE double cf_rnd_double(CF_Rnd* rnd)
{
	uint64_t value = cf_rnd_uint64(rnd);
...
CF_INLINE int cf_rnd_range_int(CF_Rnd* rnd, int min, int max)
{
	int range = (max - min) + 1;
	int value = (int)(cf_rnd_uint64(rnd) % range);
	return min + value;
}

CF_INLINE uint64_t cf_rnd_range_uint64(CF_Rnd* rnd, uint64_t min, uint64_t max)
{
	uint64_t range = (max - min) + 1;
	uint64_t value = cf_rnd_uint64(rnd) % range;
	return min + value;
}

CF_INLINE float cf_rnd_range_float(CF_Rnd* rnd, float min, float max)
{
	float range = max - min;
...
CF_INLINE double cf_rnd_range_double(CF_Rnd* rnd, double min, double max)
{
...
CF_INLINE CF_Rnd   rnd_seed(uint64_t seed) { return cf_rnd_seed(seed); }
CF_INLINE uint64_t rnd_uint64(CF_Rnd* rnd) { return cf_rnd_uint64(rnd); }
CF_INLINE float    rnd_float(CF_Rnd* rnd) { return cf_rnd_float(rnd); }
CF_INLINE double   rnd_double(CF_Rnd* rnd) { return cf_rnd_double(rnd); }
CF_INLINE int      rnd_range(CF_Rnd* rnd, int min, int max) { return cf_rnd_range_int(rnd, min, max); }
CF_INLINE uint64_t rnd_range(CF_Rnd* rnd, uint64_t min, uint64_t max) { return cf_rnd_range_uint64(rnd, min, max); }
CF_INLINE float    rnd_range(CF_Rnd* rnd, float min, float max) { return cf_rnd_range_float(rnd, min, max); }
CF_INLINE double   rnd_range(CF_Rnd* rnd, double min, double max) { return cf_rnd_range_double(rnd, min, max); }
