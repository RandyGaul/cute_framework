 ...
 */
CUTE_API CF_Leaf CUTE_CALL cf_aabb_tree_insert(CF_AabbTree* tree, CF_Aabb aabb, void* udata /*= NULL*/);
 ...
 */
CUTE_API void CUTE_CALL cf_aabb_tree_query_aabb(const CF_AabbTree* tree, CF_AabbTreeQueryFn* fn, CF_Aabb aabb, void* fn_udata /*= NULL*/);

/**
 * Finds all leafs hit by `ray`. The `fn` callback is called once per overlap. If you want to stop
 * searching, return false from `fn`, otherwise keep returning true.
 */
CUTE_API void CUTE_CALL cf_aabb_tree_query_ray(const CF_AabbTree* tree, CF_AabbTreeQueryFn* fn, CF_Ray ray, void* fn_udata /*= NULL*/);
