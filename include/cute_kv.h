 ...
 */
CUTE_API cf_result_t CUTE_CALL cf_kv_parse(cf_kv_t* kv, const void* data, size_t size);
...
CUTE_API cf_result_t CUTE_CALL cf_kv_val_uint8(cf_kv_t* kv, uint8_t* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_uint16(cf_kv_t* kv, uint16_t* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_uint32(cf_kv_t* kv, uint32_t* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_uint64(cf_kv_t* kv, uint64_t* val);

CUTE_API cf_result_t CUTE_CALL cf_kv_val_int8(cf_kv_t* kv, int8_t* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_int16(cf_kv_t* kv, int16_t* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_int32(cf_kv_t* kv, int32_t* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_int64(cf_kv_t* kv, int64_t* val);

CUTE_API cf_result_t CUTE_CALL cf_kv_val_float(cf_kv_t* kv, float* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_double(cf_kv_t* kv, double* val);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_bool(cf_kv_t* kv, bool* val);

CUTE_API cf_result_t CUTE_CALL cf_kv_val_string(cf_kv_t* kv, const char** str, size_t* size);
CUTE_API cf_result_t CUTE_CALL cf_kv_val_blob(cf_kv_t* kv, void* data, size_t data_capacity, size_t* data_len);

CUTE_API cf_result_t CUTE_CALL cf_kv_object_begin(cf_kv_t* kv, const char* key /*= NULL*/);
CUTE_API cf_result_t CUTE_CALL cf_kv_object_end(cf_kv_t* kv);

CUTE_API cf_result_t CUTE_CALL cf_kv_array_begin(cf_kv_t* kv, int* count, const char* key /*= NULL*/);
CUTE_API cf_result_t CUTE_CALL cf_kv_array_end(cf_kv_t* kv);
