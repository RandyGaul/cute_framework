...
CUTE_API cf_result_t CUTE_CALL cf_file_system_set_write_dir(const char* platform_dependent_directory);
CUTE_API cf_result_t CUTE_CALL cf_file_system_mount(const char* archive, const char* mount_point, bool append_to_path /*= true*/);
CUTE_API cf_result_t CUTE_CALL cf_file_system_dismount(const char* archive);
CUTE_API cf_result_t CUTE_CALL cf_file_system_stat(const char* virtual_path, cf_stat_t* stat);
...
CUTE_API cf_result_t CUTE_CALL cf_file_system_close(cf_file_t* file);
CUTE_API cf_result_t CUTE_CALL cf_file_system_delete(const char* virtual_path);
CUTE_API cf_result_t CUTE_CALL cf_file_system_create_dir(const char* virtual_path);
...
CUTE_API cf_result_t CUTE_CALL cf_file_system_eof(cf_file_t* file);
...
CUTE_INLINE result_t file_system_mount(const char* archive, const char* mount_point, bool append_to_path = true) { return cf_file_system_mount(archive, mount_point, append_to_path); }
CUTE_INLINE result_t file_system_dismount(const char* archive) { return cf_file_system_dismount(archive); }
CUTE_INLINE result_t file_system_stat(const char* virtual_path, stat_t* stat) { return cf_file_system_stat(virtual_path, stat); }
...
CUTE_INLINE result_t file_system_close(file_t* file) { return cf_file_system_close(file); }
CUTE_INLINE result_t file_system_delete(const char* virtual_path) { return cf_file_system_delete(virtual_path); }
CUTE_INLINE result_t file_system_create_dir(const char* virtual_path) { return cf_file_system_create_dir(virtual_path); }
...
CUTE_INLINE result_t file_system_eof(file_t* file) { return cf_file_system_eof(file); }
