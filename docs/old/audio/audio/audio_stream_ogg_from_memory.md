...
This function is asynchronous. For the synchronous io please try using [audio_load_ogg_from_memory](https://github.com/RandyGaul/cute_framework/blob/master/docs/audio/audio/audio_load_ogg_from_memory.md).
