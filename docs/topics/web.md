...
To send an [HTTPS get request](https://en.wikipedia.org/wiki/HTTP#Request_methods) call [`cf_https_get`](../web/function/cf_https_get.md), and for [post](https://en.wikipedia.org/wiki/POST_(HTTP)) call [`cf_https_post`](../web/function/cf_https_post.md). These will give you a [CF_HttpsRequest](../web/struct/cf_httpsrequest.md) in return.
