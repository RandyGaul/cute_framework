...
The music API is a higher level version of the sound_play function, and is mostly for convenience when wanting to fade or crossfade one or two music tracks together. For more fine-grained and custom control, use the sound_play function.
