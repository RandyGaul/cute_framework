...
- [cf_app_show_window](app/cf_app_show_window.md)
...
- [cf_default_display](app/cf_default_display.md)
...
- [cf_sound_set_on_finish_callback](audio/cf_sound_set_on_finish_callback.md)
...
- [cf_draw_mul](draw/cf_draw_mul.md)
- [cf_draw_peek](draw/cf_draw_peek.md)
- [cf_draw_peek_alpha_discard](draw/cf_draw_peek_alpha_discard.md)
...
- [cf_draw_pop_alpha_discard](draw/cf_draw_pop_alpha_discard.md)
...
- [cf_draw_pop_scissor](draw/cf_draw_pop_scissor.md)
...
- [cf_draw_set_atlas_dimensions](draw/cf_draw_set_atlas_dimensions.md)
...
- [cf_json_array_add_array](json/cf_json_array_add_array.md)
- [cf_json_array_add_bool](json/cf_json_array_add_bool.md)
- [cf_json_array_add_double](json/cf_json_array_add_double.md)
- [cf_json_array_add_float](json/cf_json_array_add_float.md)
- [cf_json_array_add_i64](json/cf_json_array_add_i64.md)
- [cf_json_array_add_int](json/cf_json_array_add_int.md)
- [cf_json_array_add_null](json/cf_json_array_add_null.md)
- [cf_json_array_add_object](json/cf_json_array_add_object.md)
- [cf_json_array_add_string](json/cf_json_array_add_string.md)
- [cf_json_array_add_string_range](json/cf_json_array_add_string_range.md)
- [cf_json_array_add_u64](json/cf_json_array_add_u64.md)
...
- [cf_json_array_pop](json/cf_json_array_pop.md)
...
- [cf_json_iter_done](json/cf_json_iter_done.md)
...
- [cf_json_object_add_double](json/cf_json_object_add_double.md)
- [cf_json_object_add_float](json/cf_json_object_add_float.md)
- [cf_json_object_add_i64](json/cf_json_object_add_i64.md)
...
- [cf_json_object_add_u64](json/cf_json_object_add_u64.md)
...
- [cf_ortho_2d](math/cf_ortho_2d.md)
...
- [cf_apply_blend_constants](graphics/cf_apply_blend_constants.md)
...
- [cf_apply_stencil_reference](graphics/cf_apply_stencil_reference.md)
...
- [cf_clear_canvas](graphics/cf_clear_canvas.md)
...
- [cf_color_clear](graphics/cf_color_clear.md)
...
- [cf_make_shader_from_source](graphics/cf_make_shader_from_source.md)
...
- [cf_pixel_clear](graphics/cf_pixel_clear.md)
...
- [cf_texture_handle](graphics/cf_texture_handle.md)
...
- [cf_sprite_get_loop](sprite/cf_sprite_get_loop.md)
...
- [cf_sprite_get_opacity](sprite/cf_sprite_get_opacity.md)
...
- [cf_sprite_set_frame](sprite/cf_sprite_set_frame.md)
- [cf_sprite_set_loop](sprite/cf_sprite_set_loop.md)
