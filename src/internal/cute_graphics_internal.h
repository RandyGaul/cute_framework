...
CF_INLINE SDL_GPUTextureFormat s_wrap(CF_PixelFormat format)
{
	...
	case CF_PIXEL_FORMAT_BC1_UNORM:               return SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM;
	case CF_PIXEL_FORMAT_BC2_UNORM:               return SDL_GPU_TEXTUREFORMAT_BC2_RGBA_UNORM;
	case CF_PIXEL_FORMAT_BC3_UNORM:               return SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM;
	case CF_PIXEL_FORMAT_BC7_UNORM:               return SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM;
	...
	case CF_PIXEL_FORMAT_BC3_UNORM_SRGB:          return SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM_SRGB;
	case CF_PIXEL_FORMAT_BC7_UNORM_SRGB:          return SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM_SRGB;
