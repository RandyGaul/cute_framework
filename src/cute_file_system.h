...
extern CUTE_API int CUTE_CALL file_system_stat(const char* virtual_path, cute_file_stat_t* stat);
extern CUTE_API cute_file_t* CUTE_CALL file_system_create_file(const char* virtual_path);
extern CUTE_API cute_file_t* CUTE_CALL file_system_open_file_for_write(const char* virtual_path);
extern CUTE_API cute_file_t* CUTE_CALL file_system_open_file_for_append(const char* virtual_path);
extern CUTE_API cute_file_t* CUTE_CALL file_system_open_file_for_read(const char* virtual_path);
extern CUTE_API int CUTE_CALL file_system_close(cute_file_t* file);
...
extern CUTE_API uint64_t CUTE_CALL file_system_read(cute_file_t* file, void* buffer, uint64_t bytes);
extern CUTE_API uint64_t CUTE_CALL file_system_write(cute_file_t* file, const void* buffer, uint64_t bytes);
extern CUTE_API int CUTE_CALL file_system_eof(cute_file_t* file);
extern CUTE_API uint64_t CUTE_CALL file_system_tell(cute_file_t* file);
extern CUTE_API int CUTE_CALL file_system_seek(cute_file_t* file, uint64_t position);
extern CUTE_API uint64_t CUTE_CALL file_system_size(cute_file_t* file);
extern CUTE_API int CUTE_CALL file_system_flush(cute_file_t* file);
