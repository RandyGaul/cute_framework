...
{
	CF_HandleTable* table = (CF_HandleTable*)CUTE_ALLOC(sizeof(CF_HandleTable));
	CUTE_PLACEMENT_NEW(table) CF_HandleTable();
...
static CUTE_INLINE uint32_t s_table_index(CF_Handle handle)
{
