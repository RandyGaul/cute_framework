...
int main(int argc, const char** argv)
{
	...
	test_t tests[] = {
		...
		CUTE_TEST_CASE_ENTRY(test_kv_write_delta_array),
		CUTE_TEST_CASE_ENTRY(test_kv_write_delta_blob),
		CUTE_TEST_CASE_ENTRY(test_kv_write_delta_string),
		CUTE_TEST_CASE_ENTRY(test_kv_write_delta_object),
