...
This function is asynchronous. For the synchronous io please try using [audio_load_wav_from_memory](https://github.com/RandyGaul/cute_framework/blob/master/doc/audio/audio_load_wav_from_memory.md).
