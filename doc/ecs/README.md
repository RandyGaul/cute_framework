...
The Entity Component Systems is an optional feature of Cute Framework used to organize your game code and gameplay logic. The idea is to write systems to hold your code, components to hold your data, and entities to define collections of components.
